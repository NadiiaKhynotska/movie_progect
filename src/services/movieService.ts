...
const movieService = {
    getAll: (page: number) => apiService.get<IMovie[]>(urls.films.base, {params: {page}}),
    ...
    searchByKeyWord: (query:string, page:number)=> apiService.get<IMovie[]>(urls.films.search, {params:{query,page}})
}
